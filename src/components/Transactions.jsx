    ...
    render() {
        ...
        return (
            this.props.transData.length ? <div id="transactions">
                <table>
                <tr className="transaction title"><th className = "title-col">Date</th><th className ="title-col">Vendor</th> <th className = "title-col">Category</th> <th className = "title-col">{'Amount($)'}</th></tr>
