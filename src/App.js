  ...
  return (this.state.transactions ?
    <Router>
      ...
      <div id="main-container">
        ...
        <Route exact path='/operations' render={() => <Operations transactions = {this.state.transactions}
        balance={this.balance(this.state.transactions)} loadTransactions = {this.loadTransactions} />} />
